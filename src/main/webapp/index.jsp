...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">Prodyut Ghosh</a>
			<button
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="#portfolio">Registration List</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avter.png"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome to page of Prodyut Ghosh</h1>
			<!-- Icon Divider-->
	...
	<section class="page-section portfolio" id="portfolio">
		<div class="container">
			...
			<h2
				class="page-section-heading text-center text-uppercase text-secondary mb-0">Registration List</h2>
			<!-- Icon Divider-->
  ...
  <%
				  ...
				  try {
						...
						while(rs.next()){
							%>
						 <tr >
						 <th scope="row"> <%out.println(rs.getString("uname"));%></th>
						 <td><b><%out.println(rs.getString("dOB"));%></b> </td>
						 <td><b><%out.println(rs.getString("gender")); %></b>
						 <td><b><%out.println(rs.getString("address")); %></b>
						 </tr>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">Hii,I am Prodyut Ghosh.
									As a web developer, I thrive on turning ideas into digital realities. With a keen eye for design and a knack for coding 
									I specialize in crafting sleek and responsive websites that captivate audiences and drive engagement.</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">From conceptualization to execution, I am passionate about bringing creativity and functionality together to deliver seamless user experiences.</p>
				</div>
			</div>
